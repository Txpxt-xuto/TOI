...
int main()
{
    ...
    while(l<r)
    {
        ...
        for(int i=0;i<n-mid+1;i++)
        {
            ...
            {
                check = true;
                breat requires further verification because we did not recognize your device. To complete the sign in, enter the verification code on the unrecognized devic